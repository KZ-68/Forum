    ...
    <div id="wrapper"> 
        ...
        <div id="mainpage">
            ...
            <header>
                <nav id="nav-header">
                    <div id="nav-right">
                        <a href="index.php?ctrl=home&action=home">Home Page</a>
                        <?php
                        if(App\Session::isAdmin()){
                            ?>
                            <a href="index.php?ctrl=home&action=users">Members</a>
                            <?php
                        }
                        ?>
                    </div>
                    ...
                    <?php
                        ...
                        if(App\Session::getUser()){
                            ?>
                            <a class="link-left" href="index.php?ctrl=security&action=viewProfile&id=<?=App\Session::getUser()->getId()?>"><span class="fas fa-user"></span>&nbsp;<?=App\Session::getUser()?></a>
        ...
        <footer>
            ...
            <a href="/home/forumRules.html">Code of Conduct</a>
            <a href="">Legal Notices</a>
            <a href="">Contact</a>
            </div>
            <small>&copy; 2020 - Forum CDA</small>
